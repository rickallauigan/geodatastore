...
geoserver.adminPanel.prototype.createMap_ = function() {
  ...
  GEvent.addListener(edit_control, 'view', function() { me.mode_ = 'view'; });
  GEvent.addListener(edit_control, 'point', function() { me.mode_ = 'point'; });
  GEvent.addListener(edit_control, 'line', function() { me.mode_ = 'line'; });
  GEvent.addListener(edit_control, 'poly', function() { me.mode_ = 'poly'; });
...
EditControl.prototype.initialize = function(map) {
  ...
  control_div.appendChild(status_div);
  document.getElementById('adminPanel').appendChild(control_div);
...
EditControl.prototype.createButton_ = function(button_opts) {
  ...
  GEvent.addDomListener(button_img, "click", function() { 
    ...
    me.status_div.innerHTML = button_opts.tooltip;
  });  
...
EditControl.prototype.getDefaultPosition = function() {
  return new GControlPosition(G_ANCHOR_TOP_LEFT, new GSize(260, 0));
}
